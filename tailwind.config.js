  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        subtle:
          "0px 0px 7px 0px rgba(205, 203, 203, 0.00), 0px 0px 6px 0px rgba(205, 203, 203, 0.01), 0px 0px 5px 0px rgba(205, 203, 203, 0.05), 0px 0px 4px 0px rgba(205, 203, 203, 0.09), 0px 0px 2px 0px rgba(205, 203, 203, 0.10)",
        smallBox:
