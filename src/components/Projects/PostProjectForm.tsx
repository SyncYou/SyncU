...
import useInviteContributors from "../../hooks/useInviteContributors";
...
function PostProjectForm() {
  ...
  const [suggestedContributors, setSuggestedContributors] =
  ...
  const handleSendInvites = async () => {
    try {
      await inviteContributors(contributors);
      successToast("Success", "Invites sent successfully");
      setShowInviteModal(false);
    } catch (error) {
      errorToast("Error", "Failed to send invites");
    }
  };
  ...
  if (show) {
    return (
      <Overlay>
        <form
          onSubmit={onSubmit}
          className="h-full w-[770px] rounded-[20px] bg-white"
        >
              ...
              <div className="h-20 flex flex-col gap-1">
                <div className="w-[435px] h-[60px] relative">
                  <input
                    ...
                    value={title || ""}
                    id="title"
                    className={`w-full h-full text-[#40404D] p-4 pt-8 outline-none border rounded-lg focus:border-brand400 placeholder:text-sm placeholder:text-gray400 text-base ${
                ...
                {errors.title && (
                  <p className="text-alert-600 text-xs mt-1">
                ...
                <label htmlFor="role">
                  <div
                    className={`flex flex-wrap gap-1 w-[435px] min-h-[60px] relative pt-8 pb-4 px-2 outline-none border rounded-lg ${
                      roles.length < 3 ? "border-alert-600" : ""
                    }`}
                  >
                    <label
                      className="absolute left-3 top-2 font-medium text-gray950 text-xs"
                    ...
                    {roles?.map((role, index) => (
                      <Chip
                        key={index}
                        className="bg-[#f3ecfcce] text-brand600 flex gap-3"
                      >
                        {role}{" "}
                        <span
            ...
            <div className="flex justify-between">
              ...
              <label htmlFor="stack">
                <div className="min-h-[120px] flex flex-col gap-1 relative">
                  <div
                    className={`flex flex-wrap gap-1 w-[435px] min-h-[129px] relative pt-2 pb-4 px-3 border flex-col rounded-lg ${
                      stacks.length < 3 ? "border-alert-600" : ""
                    }`}
                  >
                    <label
                    ...
                    <div className="flex flex-wrap gap-1">
                      {stacks?.map((stack, index) => (
                        <Chip
                          key={index}
                          className="bg-[#f3ecfcce] h-fit text-brand600 flex gap-3"
                        >
                          {stack}
                          <span
                  ...
                  {stacks.length < 3 && (
                    <p className="text-alert-600 text-xs mt-1">
                      Minimum 3 stacks required
                    </p>
                  )}
                  {stacks.length > 10 && (
                    <p className="text-alert-600 text-xs mt-1">
                      Maximum 10 stacks allowed
                    </p>
                  )}
                  <p className="text-right font-normal text-xs text-gray700">
                    min of 3 and a max of 10
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {workspace === "Slack" && (
                      <div className="relative h-[60px] w-[389px]">
                        ...
                        {errors.workspace?.url && (
                          <p className="text-alert-600 text-xs my-1">
                            {errors.workspace.url.message}
                          </p>
                        )}
                      </div>
                    )}
          ...
          <div className="w-full h-full border-t border-gray200 px-8 py-5 flex justify-end gap-4">
        ...
        <div className="h-[37.7rem] w-[35.5rem] bg-white shadow rounded-2xl relative">
          <div className="py-[10px] px-5 shadow flex justify-between items-center">
            <h2 className="font-semibold text-lg">
              Invite Contributors to join you
            </h2>
            <div
            ...
            >
              ...
              >
                <path
                  d="M14.5399 31.3409C13.9541 31.9266 13.9541 32.8764 14.5399 33.4623C15.1257 34.048 16.0755 34.048 16.6612 33.4623L33.4612 16.6622C34.0471 16.0764 34.0471 15.1267 33.4612 14.5409C32.8755 13.9551 31.9257 13.9551 31.3399 14.5409L14.5399 31.3409Z"
                  fill="#A6A6B5"
                />
                <path
                  d="M16.6612 14.5409C16.0755 13.9551 15.1257 13.9551 14.5399 14.5409C13.9541 15.1267 13.9541 16.0764 14.5399 16.6622L31.34 33.4623C31.9257 34.048 32.8755 34.048 33.4612 33.4623C34.047 32.8764 34.047 31.9266 33.4612 31.3409L16.6612 14.5409Z"
                  fill="#A6A6B5"
                />
              </svg>
            </div>
                          ...
                          >
                            ...
                            >
                              <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M12.3607 3.63613C12.6862 3.96159 12.6862 4.4892 12.3607 4.81464L4.81827 12.3571C4.49281 12.6826 3.96521 12.6826 3.63976 12.3571C3.3143 12.0317 3.3143 11.5041 3.63976 11.1786L11.1822 3.63613C11.5077 3.31069 12.0353 3.31067 12.3607 3.63613Z"
                                fill="#8333D0"
                              />
                              <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M3.63926 3.63613C3.96472 3.31067 4.49233 3.31069 4.81777 3.63613L12.3602 11.1786C12.6857 11.5041 12.6857 12.0317 12.3602 12.3571C12.0348 12.6826 11.5072 12.6826 11.1817 12.3571L3.63926 4.81464C3.31382 4.4892 3.3138 3.96159 3.63926 3.63613Z"
                                fill="#8333D0"
                              />
                            </svg>
                          </span>
          ...
          <div className="absolute px-2 rounded-2xl right-0 bg-white left-0 bottom-0 shadow-lg h-[5.3rem] flex items-center justify-end gap-2">
            <PrimaryButton
              ...
              disabled={inviteStatus === "pending" || contributors.length === 0}
            >
            ...
            <SecondaryButton
              ...
              onClick={() => setShowInviteModal(false)}
            >
              <span className="font-normal text-base">Skip</span>
            </SecondaryButton>
          </div>
        </div>
      </Overlay>
