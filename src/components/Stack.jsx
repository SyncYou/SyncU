            ...
            <div>
              ...
              <form action="" className='form gap-[13px]'>
                <div className='flex flex-col gap-[10px] items-center divhr'>
                  ...
                  <p className='text-h4 font-medium text-base '> This will make for a more personalized experience. </p>
                </div>
                <div className='divhr'>
                  <div className='flex rounded-lg border-2 border-fb pl-[9px] '>
                    ...
                    <input type="search" name="stack" id="" className='btn border-0 text-left py-[7px] px-[20px] focus:outline-none' placeholder='Search for skills, tools and stacks...' onKeyDown={handleEnter} />
                  </div>
                ...
                <div className='px-[48px] w-full flex items-center justify-between'>
                  <Link to="/work">
                    <button className='btn button w-[125px] bg-fbg text-h4' onKeyDown={handleEnter}>Back</button>
                  </Link>
                  <Link to='/security'>
                    <button className={`btn button w-[125px] ${stack.length >= 3 ? "bg-changeColor text-fbg" : " "}`} disabled={isValid} onKeyDown={handleEnter}>Next →</button>
                  </Link>
                </div>
              </form>
            </div>
