    ...
    <section>
      ...
      <div className="max-w-[500px] mx-auto">
        <div className="border border-[#E5E7EB] p-5 rounded-xl my-5">
          <h3 className="text-[#111827] font-semibold text-[18px] leading-[30px] border-b border-[#E5E7EB] pb-3">
            About
          </h3>
          ...
          <div>
            <div className="flex items-center gap-3 py-2">
              ...
              <small className="text-[#6B7280] leading-6">
                works at <span className="text-[#374151]">Syncu</span>{" "}
              </small>
            </div>
            <div className="flex items-center gap-3 py-2">
              <img src={location} alt="" />
              <small className="text-[#6B7280] leading-6">
                comes from <span className="text-[#374151]">Nigeria</span>{" "}
              </small>
            </div>
            <div className="flex items-center gap-3 py-2">
              <img src={linkGray} alt="" />
              <small className="text-[#374151] flex gap-2 underline">
                www.gojosat.anime <img src={linkSquare} alt="" />
              </small>
            </div>
            <div className="flex items-center gap-3 py-2">
              <img src={calendar} alt="" />
              <small className="text-[#6B7280] leading-6">
                joined <span className="text-[#374151]">2nd July , 2024</span>
              </small>
            </div>
          </div>
