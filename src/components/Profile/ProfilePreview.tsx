...
const ProfilePreview: React.FC = () => {
  return (
   <section className='bg-[#ffffff] border border-[#E6E6F0] shadow-xl shadow-[#69696917] p-[30px] rounded-[24px] flex flex-col items-center justify-between'>
        <div className='flex flex-col items-center justify-between'>
            <div className='border-4 border-[#D6D6E0] rounded-full p-5 flex items-center justify-center'>
                <FaUser size={80} className='text-[#D6D6E0]'/>
            </div>
            <div className=' my-5 font-semibold flex items-center flex-col justify-center gap-2'>
                <h2 className=' text-secondary leading-[32px] text-[28px] text-center'>Your name</h2>
                <small className=' font-medium text-gray text-center text-[16px] leading-6'>@username</small>

                <div className='flex items-center justify-center gap-3 border-[0.8px] border-[#D6D6E0] py-3 px-5 rounded-full
                my-5'>
                    <button className='text-secondary font-medium text-[16px] leading-6 text-center'>Start collaborating</button>
