...
export function Modal2({ handleSkillClick, filteredSkills }: Modal2Props) {
  ...
  return (
    <div className="flex items-start justify-between py-2 px-3 border border-solid border-gray-200 bg-white w-full max-w-[28.5rem] rounded-lg shadow-rightShadow absolute z-10 h-48 overflow-y-scroll">
