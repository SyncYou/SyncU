    ...
    return (
        <>
            ...
            {linkTo ? <Link to={linkTo}>
                ...
                :
                <button onClick={onClick} className={`flex py-[10px] px-6 justify-center items-center gap-[10px] rounded-3xl border border-gray-300 text-base font-medium text-gray-950 ${style}`}>
                    {children}
                </button>
            }
