                ...
                <div className='divhr'>
                  ...
                  <div className='flex flex-col items-start gap-[10px] w-full'>
                    ...
                    <div className='w-full flex items-center gap-0'>
                      <input onChange={handleInput} placeholder='John Doe' type='text' value={inputValue} className='allInput btn' />

                      {isFormValid && <span className='py-[0.5px] px-[4px] rounded-[50%] border-2 border-checkMark text-checkMark   text-[10px] ml-[-9vh]'>&#x2714;
                      </span>}
                    </div>
