              ...
              <form action="" className="form gap-[13px]">
                ...
                <div className="divhr">
                  <p className="text-h4 font-medium text-base ">
                    We will send an mail to User123@gmail.com, check your inbox
                    and click on the link “verify your email” button link.{" "}
                  </p>
                </div>
                <div className="px-[48px] w-full">
                  <Link to="/yourself">
                    <Buttons
                      bIcon={mail}
                      bText="Send mail link"
                      bg="var(--Primary-p-800, #672A9F)"
                      text="var(--Neutral-n-white, #FFF)"
                    />
                  </Link>
                </div>
              </form>
