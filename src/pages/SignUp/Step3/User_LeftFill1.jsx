        ...
        <>
            <div className="gap-6 self-stretch flex-col ">
                ...
                <div className="gap-3 flex-col ">
                    <h1 className="text-[32px] font-semibold text-gray-950 max-sm:text-[24px]">What are you into?</h1>
            ...
            <div className="gap-4 *:items-center flex-col ">
                ...
                <div className='flex flex-row gap-4  max-tablet:flex-wrap max-tablet:flex-row'>
                    {Niches.map((items) => (
            ...
            <div className="gap-4 flex-col relative h-fulls">
                ...
                <span className='flex items-center justify-between py-2 px-3 border border-solid border-gray-200 bg-gray-100 w-[62%] max-sm:w-full rounded-lg [&_img]:hover:cursor-pointer'>
                ...
                {isModalOpen && <StackDropDown style="top-[17vh] max-sm:w-full max-sm:h-[23vh] max-sm:top-[-20vh]" selectedStack={selectedStack} handleAreaClick={handleAreaClick} />}
            </div>
